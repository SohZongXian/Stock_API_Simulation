...
class ProducerA implements Runnable {
    ...
    public ProducerA(LinkedBlockingQueue<String> dataQueue, String identifier) {
...
class ConsumerA implements Runnable {
    ...
    public ConsumerA(LinkedBlockingQueue<String> dataQueue) {
        this.dataQueue = dataQueue;
    }
...
class ConsumerA2 implements Runnable {
    ...
    public ConsumerA2(LinkedBlockingQueue<String> dataQueue) {
        this.dataQueue = dataQueue;
    }
